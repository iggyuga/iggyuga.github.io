...
const PARAGRAPHS = [
  ...
  "I'm based in Chattanooga, TN — good trails nearby, river runs through town. Weekdays I'm heads-down on building and deploying software; on the weekends my wife and I are traveling wherever we can in the van I built out — insulation, electrical, bed platform, the whole thing. Have at least one Raspberry Pi running something at any given moment.",
